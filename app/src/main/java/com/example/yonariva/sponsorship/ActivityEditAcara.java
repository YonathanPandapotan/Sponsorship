...
public class ActivityEditAcara extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_acara);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //menyiapkan data
                final ProgressDialog progressDialog = new ProgressDialog(ActivityEditAcara.this);
                ...
                childUpdates.put(dataPost.getId(), postValues);
                                ...
                                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                                    ...
                                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                        ...
                                        if(numberUploaded == uploaded.size()){
                                            Toast.makeText(ActivityEditAcara.this, "Acara berhasil dibuat", Toast.LENGTH_LONG);
                                            Intent intent = new Intent(ActivityEditAcara.this, ActivityPost.class);
